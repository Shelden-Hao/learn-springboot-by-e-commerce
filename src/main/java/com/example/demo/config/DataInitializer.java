...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        // 批量插入 15 条商品，其中 2 条下架——演示状态筛选
        // 每行：{name, price, description, imageUrl, stock, status}
        Object[][] seedData = {
            ...
            {"电竞椅 Titan",        "2899.00", "4D 扶手 · 180° 平躺 · 冷凝胶头枕 · 承重 150kg",          "https://img.example.com/chair-titan.jpg",      15, ProductStatus.OFF_SHELF},  // 已下架
            {"电动升降桌",          "1699.00", "双电机 · 承重 120kg · 4 档记忆 · 遇阻回弹",               "https://img.example.com/desk-elevate.jpg",     25, ProductStatus.ON_SALE},
            {"挂灯 Air",            "129.00",  "重力感应调节 · Ra95 高显色 · USB 供电",                   "https://img.example.com/light-air.jpg",       200, ProductStatus.OFF_SHELF},  // 已下架
